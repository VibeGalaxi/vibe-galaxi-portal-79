...
const ContactSection = () => (
  <section id="contact" className="w-full py-16 px-4 bg-gradient-to-r from-[#1A1F2C] via-[#D946EF]/10 to-[#1EAEDB]/10">
    <div className="max-w-xl mx-auto text-center">
      <h2 className="font-orbitron text-3xl md:text-5xl text-white font-bold mb-4 drop-shadow-xl">Contact Cosmic</h2>
      <p className="text-white/80 font-montserrat mb-6">Ai întrebări, idei sau feedback intergalactic? Suntem mereu online <span className="bg-lime-400/25 rounded px-2 py-0.5 text-lime-400 font-bold ml-1">🟢 live</span></p>
